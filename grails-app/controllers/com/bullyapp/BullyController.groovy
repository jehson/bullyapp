...
class BullyController {
    ...
    def save() {
		...
		String b64 = Base64.byteArrayToBase64(bullyInstance.driversLicenseFile).toString();
		HttpClient httpClient = new DefaultHttpClient();
		String reqString = String.format("image=%s&key=%s&type=base64", b64, clientId);
        ...
        flash.message = message(code: 'default.created.message', args: [message(code: 'bully.label', default: 'Bully'), bullyInstance.id])
    ...
    def show(Long id) {
        ...
        if (!bullyInstance) {
            flash.message = message(code: 'default.not.found.message', args: [message(code: 'bully.label', default: 'Bully'), id])
    ...
    def update(Long id, Long version) {
        ...
        flash.message = message(code: 'default.updated.message', args: [message(code: 'bully.label', default: 'Bully'), bullyInstance.id])
        redirect(action: "show", id: bullyInstance.id)
    }
    ...
    def delete(Long id) {
        ...
        try {
            ...
            flash.message = message(code: 'default.deleted.message', args: [message(code: 'bully.label', default: 'Bully'), id])
            redirect(action: "list")
        }
        catch (DataIntegrityViolationException e) {
            flash.message = message(code: 'default.not.deleted.message', args: [message(code: 'bully.label', default: 'Bully'), id])
